...
This will add the forest stat by tree cover density threshold and by year (if applicable-- not applicable for biomass density, tree cover 2000, etc.).
...
`python cumsum_hadoop_output.py --input s3://gfw2-data/alerts-tsv/output/loss.csv --max-year 2017 --analysis-name loss`
