...
files_to_intersect = ['peat_all_single_dis2.zip', 'mangrove_dis.zip', 'water_stress.zip', 'wdpa_protected_areas_dis.zip', 'Oil_palm_concessions_select_countries_dis.zip', 'mining_concessions_dis.zip', 'gfw_logging_single_dis.zip', 'Resource_rights_select_countries_dis', 'land_rights_dis.zip', 'community_level_data_landmark_dis_prj.zip']
